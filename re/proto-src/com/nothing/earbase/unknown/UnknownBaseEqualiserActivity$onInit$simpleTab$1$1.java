...
@DebugMetadata(c = "com.nothing.earbase.unknown.UnknownBaseEqualiserActivity$onInit$simpleTab$1$1", f = "UnknownBaseEqualiserActivity.kt", i = {0, 0}, l = {TypedValues.PositionType.TYPE_POSITION_TYPE, 246}, m = "invokeSuspend", n = {"entity", "needUpdate$iv"}, s = {"L$0", "I$0"})
final class UnknownBaseEqualiserActivity$onInit$simpleTab$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int I$0;
    Object L$0;
    Object L$1;
    int label;
    ...
    UnknownBaseEqualiserActivity$onInit$simpleTab$1$1(UnknownBaseEqualiserActivity unknownBaseEqualiserActivity, Continuation<? super UnknownBaseEqualiserActivity$onInit$simpleTab$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UnknownBaseEqualiserActivity$onInit$simpleTab$1$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((UnknownBaseEqualiserActivity$onInit$simpleTab$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Code restructure failed: missing block: B:44:0x0108, code lost:
    
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.earbase.unknown.UnknownBaseEqualiserActivity$onInit$simpleTab$1$1.AnonymousClass2(r19.this$0, null), r19) == r1) goto L45;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            if (tWSDevice == null || (tWSDeviceBuilderAdvanceCustomEQMode = TWSDeviceExtKt.advanceCustomEQMode(tWSDevice, AdvanceCustomEQEntity.Mode.OFF)) == null) {
                this.L$0 = null;
                this.L$1 = null;
                this.label = 2;
            } else {
        ...
        if (message != null && message.isOk()) {
            ...
            if (advanceCustomEQEntity != null) {
                advanceCustomEQEntity.setModel(AdvanceCustomEQEntity.Mode.OFF);
            }
    ...
    /* JADX INFO: renamed from: com.nothing.earbase.unknown.UnknownBaseEqualiserActivity$onInit$simpleTab$1$1$2, reason: invalid class name */
    /* JADX INFO: compiled from: UnknownBaseEqualiserActivity.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.earbase.unknown.UnknownBaseEqualiserActivity$onInit$simpleTab$1$1$2", f = "UnknownBaseEqualiserActivity.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ UnknownBaseEqualiserActivity this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(UnknownBaseEqualiserActivity unknownBaseEqualiserActivity, Continuation<? super AnonymousClass2> continuation) {
            super(2, continuation);
            this.this$0 = unknownBaseEqualiserActivity;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            Fragment fragment = this.this$0.getFragmentList().get(0);
            ...
            Fragment fragment2 = this.this$0.getFragmentList().get(1);
            Intrinsics.checkNotNull(fragment2, "null cannot be cast to non-null type com.nothing.base.view.BaseFragment<*>");
            ((BaseFragment) fragment2).onResumeLazy(3);
            return Unit.INSTANCE;
        }
    }
}
