...
@DebugMetadata(c = "com.nothing.earbase.equalizer.activity.BaseEqualiserActivity$onInit$simpleTab$1$1", f = "BaseEqualiserActivity.kt", i = {0, 0}, l = {484, 251}, m = "invokeSuspend", n = {"entity", "needUpdate$iv"}, s = {"L$0", "I$0"})
final class BaseEqualiserActivity$onInit$simpleTab$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int I$0;
    Object L$0;
    Object L$1;
    int label;
    ...
    BaseEqualiserActivity$onInit$simpleTab$1$1(BaseEqualiserActivity baseEqualiserActivity, Continuation<? super BaseEqualiserActivity$onInit$simpleTab$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseEqualiserActivity$onInit$simpleTab$1$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BaseEqualiserActivity$onInit$simpleTab$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Code restructure failed: missing block: B:44:0x0108, code lost:
    
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.earbase.equalizer.activity.BaseEqualiserActivity$onInit$simpleTab$1$1.AnonymousClass2(r19.this$0, null), r19) == r1) goto L45;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    ...
    /* JADX INFO: renamed from: com.nothing.earbase.equalizer.activity.BaseEqualiserActivity$onInit$simpleTab$1$1$2, reason: invalid class name */
    /* JADX INFO: compiled from: BaseEqualiserActivity.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.earbase.equalizer.activity.BaseEqualiserActivity$onInit$simpleTab$1$1$2", f = "BaseEqualiserActivity.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
