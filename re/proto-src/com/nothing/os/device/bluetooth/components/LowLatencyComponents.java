...
/* JADX INFO: compiled from: LowLatencyComponents.kt */
/* JADX INFO: loaded from: /tmp/source/classes7.dex */
@Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u00a2\u0006\u0004\b\b\u0010\tJ\u0010\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u0018H\u0016J\b\u0010\u0019\u001a\u00020\u0016H\u0016J\b\u0010\u001a\u001a\u00020\u001bH\u0016J\u0016\u0010\u001c\u001a\u00020\u00182\u0006\u0010\u001d\u001a\u00020\u001eH\u0096@\u00a2\u0006\u0002\u0010\u001fR\u001b\u0010\n\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\f\u0018\u00010\u000b\u00a2\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u001a\u0010\u000f\u001a\u00020\u0010X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014\u00a8\u0006 "}, d2 = {"Lcom/nothing/os/device/bluetooth/components/LowLatencyComponents;", "Lcom/nothing/device/BaseFunctionComponents;", "context", "Landroid/content/Context;", "iotDevice", "Lcom/nothing/device/IOTDevice;", "lifecycleOwner", "Landroidx/lifecycle/LifecycleOwner;", "<init>", "(Landroid/content/Context;Lcom/nothing/device/IOTDevice;Landroidx/lifecycle/LifecycleOwner;)V", "liveData", "Landroidx/lifecycle/LiveData;", "Lcom/nothing/base/protocol/entity/BasicBoolean;", "getLiveData", "()Landroidx/lifecycle/LiveData;", "lowLatencyViewModel", "Lcom/nothing/os/device/bluetooth/adapter/SwitchItemViewModel;", "getLowLatencyViewModel", "()Lcom/nothing/os/device/bluetooth/adapter/SwitchItemViewModel;", "setLowLatencyViewModel", "(Lcom/nothing/os/device/bluetooth/adapter/SwitchItemViewModel;)V", "addListener", "", "clearObserver", "", "refresh", "getComponentsModel", "Lcom/nothing/base/adapter/CommonBindingMoreType;", "onClickSwitchItem", "view", "Landroid/view/View;", "(Landroid/view/View;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "nt_ear_GoogleStoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class LowLatencyComponents extends BaseFunctionComponents {
    private final LiveData<BasicBoolean> liveData;
    private SwitchItemViewModel lowLatencyViewModel;

    /* JADX INFO: renamed from: com.nothing.os.device.bluetooth.components.LowLatencyComponents$onClickSwitchItem$1, reason: invalid class name */
    /* JADX INFO: compiled from: LowLatencyComponents.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.os.device.bluetooth.components.LowLatencyComponents", f = "LowLatencyComponents.kt", i = {0, 0, 0}, l = {63}, m = "onClickSwitchItem", n = {"this", "state", "needUpdate$iv"}, s = {"L$0", "I$0", "I$1"})
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return LowLatencyComponents.this.onClickSwitchItem(null, this);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LowLatencyComponents(Context context, IOTDevice iotDevice, LifecycleOwner lifecycleOwner) {
        final TWSDeviceBuilder tWSDeviceBuilderLagMode$default;
        ...
        if (twsDevice != null && (tWSDeviceBuilderLagMode$default = TWSDeviceExtKt.lagMode$default(twsDevice, null, 1, null)) != null) {
            final Class<BasicBoolean> cls = BasicBoolean.class;
            map = Transformations.map(tWSDeviceBuilderLagMode$default.getTwsDevice().getCommandCache().getLiveDataCommand(tWSDeviceBuilderLagMode$default.getGetCommand(), tWSDeviceBuilderLagMode$default.getNotifyCommand()), new Function1<Message, BasicBoolean>() { // from class: com.nothing.os.device.bluetooth.components.LowLatencyComponents$special$$inlined$getLiveData$1
        ...
        this.liveData = map;
        SwitchItemViewModel switchItemViewModel = new SwitchItemViewModel(715);
        switchItemViewModel.getTitle().set(context.getString(R.string.sound_low_latency_mode));
        String string = context.getString(R.string.sound_low_latency_mode_tips);
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        switchItemViewModel.setSummary(string);
        this.lowLatencyViewModel = switchItemViewModel;
        addListener(true);
    }

    public final LiveData<BasicBoolean> getLiveData() {
        return this.liveData;
    }

    public final SwitchItemViewModel getLowLatencyViewModel() {
        return this.lowLatencyViewModel;
    }

    public final void setLowLatencyViewModel(SwitchItemViewModel switchItemViewModel) {
        Intrinsics.checkNotNullParameter(switchItemViewModel, "<set-?>");
        this.lowLatencyViewModel = switchItemViewModel;
    }
    ...
    public void addListener(boolean clearObserver) {
        ...
        LiveData<BasicBoolean> liveData2 = this.liveData;
        if (liveData2 != null) {
            liveData2.observe(getLifecycleOwner(), new LowLatencyComponents$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.os.device.bluetooth.components.LowLatencyComponents$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return LowLatencyComponents.addListener$lambda$1(this.f$0, (BasicBoolean) obj);
                }
            }));
        }
    }
    ...
    public static final Unit addListener$lambda$1(LowLatencyComponents lowLatencyComponents, BasicBoolean basicBoolean) {
        boolean z = false;
        if (basicBoolean != null && basicBoolean.getOpen()) {
            z = true;
        }
        lowLatencyComponents.lowLatencyViewModel.getChecked().set(Boolean.valueOf(z));
    ...
    public Object onClickSwitchItem(View view, Continuation<? super Boolean> continuation) {
        ...
        int i;
        LowLatencyComponents lowLatencyComponents;
        int i2;
        ...
        if (i3 == 0) {
            ...
            LiveData<BasicBoolean> liveData = this.liveData;
            boolean z = !((liveData == null || (value = liveData.getValue()) == null) ? false : value.getOpen());
            this.lowLatencyViewModel.getChecked().set(Boxing.boxBoolean(z));
            TWSDevice twsDevice = getIotDevice().getTwsDevice();
            if (twsDevice != null && (tWSDeviceBuilderLagMode = TWSDeviceExtKt.lagMode(twsDevice, Boxing.boxBoolean(z))) != null) {
                int setCommand = tWSDeviceBuilderLagMode.getSetCommand();
                TWSDevice twsDevice2 = tWSDeviceBuilderLagMode.getTwsDevice();
                byte[] setPayload = tWSDeviceBuilderLagMode.getSetPayload();
                Long timeOut = tWSDeviceBuilderLagMode.getTimeOut();
                boolean isNeedFsn = tWSDeviceBuilderLagMode.getIsNeedFsn();
                byte[] mockResponse = tWSDeviceBuilderLagMode.getMockResponse();
                anonymousClass2.L$0 = this;
                anonymousClass2.L$1 = tWSDeviceBuilderLagMode;
        ...
        lowLatencyComponents = (LowLatencyComponents) anonymousClass2.L$0;
        ResultKt.throwOnFailure(obj);
        ...
        if (message != null && message.isOk()) {
            ...
            LiveData<BasicBoolean> liveData2 = lowLatencyComponents.liveData;
            if (liveData2 != null && (value3 = liveData2.getValue()) != null) {
                value3.setOpen(i != 0);
            }
            LiveData<BasicBoolean> liveData3 = lowLatencyComponents.liveData;
