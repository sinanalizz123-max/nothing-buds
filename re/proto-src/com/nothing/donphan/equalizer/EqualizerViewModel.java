...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u0000 #2\u00020\u0001:\u0001#B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u00a2\u0006\u0004\b\u0004\u0010\u0005J\u000e\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0002\u001a\u00020\u0013J\b\u0010\u0014\u001a\u00020\u0012H\u0016J\b\u0010\u0015\u001a\u00020\u0012H\u0016J\b\u0010\u0016\u001a\u00020\u0017H\u0016J\b\u0010\u0018\u001a\u00020\u0012H\u0016J&\u0010\u0019\u001a\u00020\u00122\u0006\u0010\u001a\u001a\u00020\u001b2\u0014\u0010\u001c\u001a\u0010\u0012\u0004\u0012\u00020\u0017\u0012\u0004\u0012\u00020\u0012\u0018\u00010\u001dH\u0016J\u0010\u0010\u001e\u001a\u00020\u001f2\u0006\u0010 \u001a\u00020!H\u0016J\u0010\u0010\"\u001a\u00020\u001f2\u0006\u0010 \u001a\u00020!H\u0016R\u0011\u0010\u0002\u001a\u00020\u0003\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0018\u0010\b\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\n\u0018\u00010\tX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u001f\u0010\u000b\u001a\u0010\u0012\f\u0012\n \u000e*\u0004\u0018\u00010\r0\r0\f\u00a2\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010\u00a8\u0006$"}, d2 = {"Lcom/nothing/donphan/equalizer/EqualizerViewModel;", "Lcom/nothing/earbase/equalizer/viewmodel/BaseEqualizerViewModel;", "context", "Landroid/app/Application;", "<init>", "(Landroid/app/Application;)V", "getContext", "()Landroid/app/Application;", "diracOpteoEQLiveData", "Landroidx/lifecycle/LiveData;", "Lcom/nothing/base/protocol/entity/BasicInt;", "hasDiracEq", "Landroidx/databinding/ObservableField;", "", "kotlin.jvm.PlatformType", "getHasDiracEq", "()Landroidx/databinding/ObservableField;", "setPowerByTextBuilder", "", "Landroid/content/Context;", "register", "getEQData", "getDiracEQRes", "", "initSoundTypes", "setEQMode", "typeViewModel", "Lcom/nothing/earbase/equalizer/viewmodel/EqualizerTypeViewModel;", "action", "Lkotlin/Function1;", "getFreq", "", "radarItem", "Lcom/nothing/base/wiget/radar/EQLabelItem;", "getQ", "Companion", "nt_ear_GoogleStoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class EqualizerViewModel extends BaseEqualizerViewModel {
    ...
    public static final int DIRAC_EQ = 7;
    ...
    private final ObservableField<Boolean> hasDiracEq;
    ...
    public EqualizerViewModel(Application context) {
        ...
        this.hasDiracEq = new ObservableField<>(true);
    }
    ...
    public final ObservableField<Boolean> getHasDiracEq() {
        return this.hasDiracEq;
    }
    ...
    public void register() {
        setProtocol(new DonphanSppProtocol(getAddress()));
        super.register();
    }
    ...
    public void getEQData() {
        ...
        liveDataDistinctUntilChanged.observe(this, new EqualizerViewModel$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.donphan.equalizer.EqualizerViewModel$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
    ...
    public void initSoundTypes() {
        ...
        if (iOTDevice != null && iOTDevice.isSupportDirac()) {
            getEqualizerTypes().add(new EqualizerTypeViewModel("10", new ObservableField(localizedResources.getString(R.string.dirac_eq_opteo)), 0, getDiracEQRes(), null, null, 0, SdkConfig.SDK_VERSION, null));
        ...
        this.hasDiracEq.set(false);
        getEqualizerTypes().add(new EqualizerTypeViewModel("11", new ObservableField(localizedResources.getString(R.string.dirac_eq)), 7, getIsSystemPage() ? R.drawable.equalizer_new_dirac_eq : R.drawable.equalizer_new_dirac_eq, null, null, 0, SdkConfig.SDK_VERSION, null));
        getEqualizerTypes().add(new EqualizerTypeViewModel(DeviceConstant.NOISE_CANCELLATION_ADAPTIVE, new ObservableField(localizedResources.getString(R.string.eq_advanced_genre_pop)), 3, getIsSystemPage() ? R.drawable.os_equalizer_pop : R.drawable.equalizer_pop, null, null, 0, SdkConfig.SDK_VERSION, null));
        getEqualizerTypes().add(new EqualizerTypeViewModel("6", new ObservableField(localizedResources.getString(R.string.eq_advanced_genre_rock)), 1, getIsSystemPage() ? R.drawable.os_equalizer_rock : R.drawable.equalizer_rock, null, null, 0, SdkConfig.SDK_VERSION, null));
        getEqualizerTypes().add(new EqualizerTypeViewModel(DeviceConstant.NOISE_CANCELLATION_TRANSPARENCY, new ObservableField(localizedResources.getString(R.string.eq_advanced_genre_electronic)), 2, getIsSystemPage() ? R.drawable.os_equalizer_electronic : R.drawable.equalizer_electronic, null, null, 0, SdkConfig.SDK_VERSION, null));
        getEqualizerTypes().add(new EqualizerTypeViewModel("9", new ObservableField(localizedResources.getString(R.string.dirac_eq_enhance_vocals)), 4, getIsSystemPage() ? R.drawable.os_equalizer_vocals : R.drawable.equalizer_vocals, null, null, 0, SdkConfig.SDK_VERSION, null));
    ...
    public void setEQMode(EqualizerTypeViewModel typeViewModel, Function1<? super Integer, Unit> action) {
        ...
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), Dispatchers.getIO(), null, new AnonymousClass2(typeViewModel, this, null), 2, null);
    }

    /* JADX INFO: renamed from: com.nothing.donphan.equalizer.EqualizerViewModel$setEQMode$2, reason: invalid class name */
    /* JADX INFO: compiled from: EqualizerViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.donphan.equalizer.EqualizerViewModel$setEQMode$2", f = "EqualizerViewModel.kt", i = {0}, l = {TypedValues.AttributesType.TYPE_EASING, 257}, m = "invokeSuspend", n = {"needUpdate$iv"}, s = {"I$0"})
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(EqualizerTypeViewModel equalizerTypeViewModel, EqualizerViewModel equalizerViewModel, Continuation<? super AnonymousClass2> continuation) {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:53:0x0169, code lost:
            ...
            if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.donphan.equalizer.EqualizerViewModel.AnonymousClass2.AnonymousClass1(r2, r19.this$0, r19.$typeViewModel, null), r19) == r1) goto L54;
         */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (tWSDevice != null && (tWSDeviceBuilderDiracOpteoEQ = TWSDeviceExtKt.diracOpteoEQ(tWSDevice, this.$typeViewModel.getType())) != null) {
                    ...
                    productByMacAddress = IOTDeviceManager.INSTANCE.getProductByMacAddress(this.this$0.getAddress());
        ...
        /* JADX INFO: renamed from: com.nothing.donphan.equalizer.EqualizerViewModel$setEQMode$2$1, reason: invalid class name */
        /* JADX INFO: compiled from: EqualizerViewModel.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
        @DebugMetadata(c = "com.nothing.donphan.equalizer.EqualizerViewModel$setEQMode$2$1", f = "EqualizerViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass1(Boolean bool, EqualizerViewModel equalizerViewModel, EqualizerTypeViewModel equalizerTypeViewModel, Continuation<? super AnonymousClass1> continuation) {
                super(2, continuation);
                this.$success = bool;
                this.this$0 = equalizerViewModel;
                this.$typeViewModel = equalizerTypeViewModel;
