...
@DebugMetadata(c = "com.nothing.espeon.control.ControlViewModel$setGestureData$1$1", f = "ControlViewModel.kt", i = {}, l = {151, 156}, m = "invokeSuspend", n = {}, s = {})
final class ControlViewModel$setGestureData$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x007c, code lost:
        ...
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.espeon.control.ControlViewModel$setGestureData$1$1.AnonymousClass1(r4, r9.this$0, r9.$dialogItemViewModel, r9.$viewModel, null), r9) == r0) goto L19;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.this$0.syncGestureData(this.$dialogItemViewModel, this.$it, this.$viewModel);
            EspeonSppProtocol protocol = this.this$0.getProtocol();
            ControlConfigurationEntity.Operation operation = this.$it;
            int operation2 = this.$dialogItemViewModel.getOperation();
            Integer button = this.$dialogItemViewModel.getButton();
            int iIntValue = button != null ? button.intValue() : this.$it.getButton();
            this.label = 1;
            obj = protocol.setGestureData(operation, operation2, iIntValue, this);
    ...
    /* JADX INFO: renamed from: com.nothing.espeon.control.ControlViewModel$setGestureData$1$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: ControlViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.espeon.control.ControlViewModel$setGestureData$1$1$1", f = "ControlViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            if (this.$result) {
                this.this$0.setVisibleOrGoneNoiseSubItems(this.$dialogItemViewModel, this.$viewModel);
