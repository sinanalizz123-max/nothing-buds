package com.nothing.ear.flaffy.core.protocol;

import android.util.Log;
import com.nothing.core.ext.TWSDeviceExtKt;
import com.nothing.ear.flaffy.core.device.IOTProductDeviceFlaffy;
...
public final class FlaffySppProtocol extends BaseSppProtocol {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return FlaffySppProtocol.this.set3DMode(0, this);
        }
    }

    /* JADX INFO: renamed from: com.nothing.ear.flaffy.core.protocol.FlaffySppProtocol$setDualEnable$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: FlaffySppProtocol.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.ear.flaffy.core.protocol.FlaffySppProtocol", f = "FlaffySppProtocol.kt", i = {}, l = {57}, m = "setDualEnable", n = {}, s = {})
    static final class C05271 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return FlaffySppProtocol.this.setDualEnable(0, this);
        }
    }

    /* JADX INFO: renamed from: com.nothing.ear.flaffy.core.protocol.FlaffySppProtocol$setPersonalizedANC$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: FlaffySppProtocol.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.ear.flaffy.core.protocol.FlaffySppProtocol", f = "FlaffySppProtocol.kt", i = {}, l = {39}, m = "setPersonalizedANC", n = {}, s = {})
    static final class C05281 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return FlaffySppProtocol.this.setPersonalizedANC(0, this);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public FlaffySppProtocol() {
        this(null, 1, 0 == true ? 1 : 0);
    }

    public /* synthetic */ FlaffySppProtocol(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str);
    }

    public FlaffySppProtocol(String str) {
        super(str, IOTProductDeviceFlaffy.EAR_ID);
    }
    ...
    public final Object setPersonalizedANC(int i, Continuation<? super Boolean> continuation) {
        ...
        Object sync$default = c05281.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c05281.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(sync$default);
            ...
            if (tWSDevice == null || (tWSDeviceBuilderPersonalizedAnc = TWSDeviceExtKt.personalizedAnc(tWSDevice, Boxing.boxInt(i))) == null) {
                ...
                c05281.label = 1;
                sync$default = TWSDeviceBuilder.setSync$default(tWSDeviceBuilderPersonalizedAnc, null, c05281, 1, null);
                if (sync$default == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
    ...
    public final Object setDualEnable(int i, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C05271) {
            ...
            if ((c05271.label & Integer.MIN_VALUE) != 0) {
                c05271.label -= Integer.MIN_VALUE;
            } else {
        ...
        Object sync$default = c05271.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c05271.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(sync$default);
            ...
            if (tWSDevice == null || (tWSDeviceBuilderDual = TWSDeviceExtKt.dual(tWSDevice, Boxing.boxInt(i))) == null) {
                ...
                c05271.label = 1;
                sync$default = TWSDeviceBuilder.setSync$default(tWSDeviceBuilderDual, null, c05271, 1, null);
                if (sync$default == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
