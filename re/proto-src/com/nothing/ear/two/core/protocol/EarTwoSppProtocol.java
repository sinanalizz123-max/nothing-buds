package com.nothing.ear.two.core.protocol;

import android.util.Log;
import com.nothing.base.util.ext.DataExtKt;
import com.nothing.core.ext.TWSDeviceExtKt;
import com.nothing.ear.two.core.device.IOTProductDeviceEarTwo;
...
public final class EarTwoSppProtocol extends BaseSppProtocol {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return EarTwoSppProtocol.this.set3DMode(0, this);
        }
    }

    /* JADX INFO: renamed from: com.nothing.ear.two.core.protocol.EarTwoSppProtocol$setDualEnable$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: EarTwoSppProtocol.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.ear.two.core.protocol.EarTwoSppProtocol", f = "EarTwoSppProtocol.kt", i = {}, l = {95}, m = "setDualEnable", n = {}, s = {})
    static final class C05851 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return EarTwoSppProtocol.this.setDualEnable(0, this);
        }
    }

    /* JADX INFO: renamed from: com.nothing.ear.two.core.protocol.EarTwoSppProtocol$setPersonalizedANC$1, reason: invalid class name and case insensitive filesystem */
    /* JADX INFO: compiled from: EarTwoSppProtocol.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.ear.two.core.protocol.EarTwoSppProtocol", f = "EarTwoSppProtocol.kt", i = {}, l = {UltraBassComponents.BASS_BOOST_LEVEL4_PROGRESS}, m = "setPersonalizedANC", n = {}, s = {})
    static final class C05861 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return EarTwoSppProtocol.this.setPersonalizedANC(0, this);
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public EarTwoSppProtocol() {
        this(null, 1, 0 == true ? 1 : 0);
    }

    public /* synthetic */ EarTwoSppProtocol(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str);
    }

    public EarTwoSppProtocol(String str) {
        super(str, IOTProductDeviceEarTwo.EAR_ID);
    }
    ...
    public final Object setPersonalizedANC(int i, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C05861) {
            c05861 = (C05861) continuation;
            if ((c05861.label & Integer.MIN_VALUE) != 0) {
                c05861.label -= Integer.MIN_VALUE;
            } else {
                c05861 = new C05861(continuation);
            }
        } else {
            c05861 = new C05861(continuation);
        }
        Object sync$default = c05861.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c05861.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(sync$default);
            ...
            if (tWSDevice == null || (tWSDeviceBuilderPersonalizedAnc = TWSDeviceExtKt.personalizedAnc(tWSDevice, Boxing.boxInt(i))) == null) {
                ...
                c05861.label = 1;
                sync$default = TWSDeviceBuilder.setSync$default(tWSDeviceBuilderPersonalizedAnc, null, c05861, 1, null);
                if (sync$default == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
    ...
    public final Object setDualEnable(int i, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C05851) {
            c05851 = (C05851) continuation;
            if ((c05851.label & Integer.MIN_VALUE) != 0) {
                c05851.label -= Integer.MIN_VALUE;
            } else {
                c05851 = new C05851(continuation);
            }
        } else {
            c05851 = new C05851(continuation);
        }
        Object sync$default = c05851.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c05851.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(sync$default);
            ...
            if (tWSDevice == null || (tWSDeviceBuilderDual = TWSDeviceExtKt.dual(tWSDevice, Boxing.boxInt(i))) == null) {
                ...
                c05851.label = 1;
                sync$default = TWSDeviceBuilder.setSync$default(tWSDeviceBuilderDual, null, c05851, 1, null);
                if (sync$default == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
