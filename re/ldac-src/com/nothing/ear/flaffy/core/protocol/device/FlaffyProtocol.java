package com.nothing.ear.flaffy.core.protocol.device;

import com.google.firebase.remoteconfig.RemoteConfigComponent;
import com.nothing.base.protocol.constant.ProtocolConstant;
import com.nothing.ear.flaffy.core.protocol.entity.FirmwareVersion;
...
public final class FlaffyProtocol extends ProtocolModel {
    ...
    public String parseVersion(Message message, String adress) {
        ...
        if (versionStr.length() > 0) {
            FlaffyManager.INSTANCE.updateDeviceDaoVersion(versionStr, adress);
        }
