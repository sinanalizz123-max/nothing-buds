package com.nothing.ear.two.core.protocol.device;

import com.google.firebase.remoteconfig.RemoteConfigComponent;
import com.nothing.base.protocol.constant.ProtocolConstant;
import com.nothing.ear.two.core.protocol.entity.FirmwareVersion;
...
public final class EarTwoProtocol extends ProtocolModel {
    ...
    public String parseVersion(Message message, String address) {
        ...
        if (versionStr.length() > 0) {
            EarTwoManager.INSTANCE.updateDeviceDaoVersion(versionStr, address);
        }
