package com.nothing.ear.twos.core.protocol.device;

import android.util.Log;
import com.google.firebase.remoteconfig.RemoteConfigComponent;
import com.nothing.base.protocol.constant.ProtocolConstant;
import com.nothing.ear.twos.core.protocol.entity.FirmwareVersion;
...
public final class EarTwosProtocol extends ProtocolModel {
    ...
    public String parseVersion(Message message, String address) {
        ...
        if (versionStr.length() > 0) {
            EarTwosManager.INSTANCE.updateDeviceDaoVersion(versionStr, address);
        }
