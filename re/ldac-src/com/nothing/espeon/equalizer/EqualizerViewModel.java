...
public final class EqualizerViewModel extends BaseEqualizerViewModel {
    ...
    public void getEQData() {
        ...
        liveDataDistinctUntilChanged.observe(this, new EqualizerViewModel$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.espeon.equalizer.EqualizerViewModel$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
    ...
    public void initSoundTypes() {
        ...
        getEqualizerTypes().add(new EqualizerTypeViewModel("10", new ObservableField(localizedResources.getString(R.string.dirac_eq_opteo_new)), 0, getDiracEQRes(), new ObservableField(false), new ObservableField(true), R.drawable.dirac_eq_selector));
    ...
    /* JADX INFO: renamed from: com.nothing.espeon.equalizer.EqualizerViewModel$sendEqModelData$1, reason: invalid class name */
    /* JADX INFO: compiled from: EqualizerViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.espeon.equalizer.EqualizerViewModel$sendEqModelData$1", f = "EqualizerViewModel.kt", i = {0}, l = {269, AnimalBaseGuideActivity.REPEAT_TWO_START}, m = "invokeSuspend", n = {"needUpdate$iv"}, s = {"I$0"})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:53:0x0163, code lost:
            ...
            if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.espeon.equalizer.EqualizerViewModel.AnonymousClass1.C01611(r2, r19.this$0, r19.$typeViewModel, null), r19) == r1) goto L54;
         */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        */
        ...
        /* JADX INFO: renamed from: com.nothing.espeon.equalizer.EqualizerViewModel$sendEqModelData$1$1, reason: invalid class name and collision with other inner class name */
        /* JADX INFO: compiled from: EqualizerViewModel.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
        @DebugMetadata(c = "com.nothing.espeon.equalizer.EqualizerViewModel$sendEqModelData$1$1", f = "EqualizerViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
        static final class C01611 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01611(Boolean bool, EqualizerViewModel equalizerViewModel, EqualizerTypeViewModel equalizerTypeViewModel, Continuation<? super C01611> continuation) {
                super(2, continuation);
                this.$success = bool;
                this.this$0 = equalizerViewModel;
                this.$typeViewModel = equalizerTypeViewModel;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01611(this.$success, this.this$0, this.$typeViewModel, continuation);
            }
