...
import com.nothing.ear.databinding.GligarControlOperationActivityBinding;
...
public final class ControlOperationActivity extends BaseControlOperationActivity<GligarControlOperationActivityBinding> {
    ...
    public void onBackPressedInner() {
        ((GligarControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((GligarControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.gligar_control_operation_activity);
        int i = BR.viewModel;
        ControlViewModel controlViewModel3 = this.viewModel;
        if (controlViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        ((GligarControlOperationActivityBinding) getMBinding()).rvOperation.setLayoutManager(new LinearLayoutManager(this));
        ((GligarControlOperationActivityBinding) getMBinding()).setEventHandler(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isRight() {
        return ((GligarControlOperationActivityBinding) getMBinding()).ivRight.getScaleX() == 1.0f;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isLeft() {
        return ((GligarControlOperationActivityBinding) getMBinding()).ivLeft.getScaleX() == 1.0f;
    }
    ...
    public final void onClickLeft(ControlViewModel viewModel) {
        ...
        if (checkValid()) {
            ...
            if (!isLeft()) {
                AppCompatImageView ivLeft = ((GligarControlOperationActivityBinding) getMBinding()).ivLeft;
                Intrinsics.checkNotNullExpressionValue(ivLeft, "ivLeft");
                AppCompatImageView ivRight = ((GligarControlOperationActivityBinding) getMBinding()).ivRight;
                Intrinsics.checkNotNullExpressionValue(ivRight, "ivRight");
                AppCompatTextView tvLeft = ((GligarControlOperationActivityBinding) getMBinding()).tvLeft;
                Intrinsics.checkNotNullExpressionValue(tvLeft, "tvLeft");
                AppCompatTextView tvRight = ((GligarControlOperationActivityBinding) getMBinding()).tvRight;
    ...
    private final void onClickChangeData(final ControlGestureViewModel itemViewModel) {
        ...
        ((GligarControlOperationActivityBinding) getMBinding()).rvOperation.setAdapter(new CommonBindingAdapter.Builder().setLayoutId(R.layout.gligar_control_dialog_item).setEventHandler((Object) this).addVariable(BR.itemViewModel, (Object) itemViewModel).setDataList((ObservableArrayList) itemViewModel.getOperationList()).build());
        ControlViewModel controlViewModel = this.viewModel;
        if (controlViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            controlViewModel = null;
        ...
        ((GligarControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(8);
        ((GligarControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((GligarControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(8);
        ((GligarControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
        if (Intrinsics.areEqual((Object) itemViewModel.isLeft().get(), (Object) true)) {
            ((GligarControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(0);
            ((GligarControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.gligar.control.ControlOperationActivity$$ExternalSyntheticLambda0
            ...
            ((GligarControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(0);
            ((GligarControlOperationActivityBinding) getMBinding()).rightLottie.postDelayed(new Runnable() { // from class: com.nothing.gligar.control.ControlOperationActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final void onClickChangeData$lambda$2(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setRepeatCount(-1);
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.playAnimation();
    }
    ...
    public static final void onClickChangeData$lambda$3(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setRepeatCount(-1);
        ((GligarControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.playAnimation();
    }
    ...
    private final void setDefaultScaleSelected() {
        ...
        controlViewModel.getDataUpdate().observe(this, new ControlOperationActivityKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.gligar.control.ControlOperationActivity$$ExternalSyntheticLambda2
        ...
        if (this.isSelectLeft) {
            ((GligarControlOperationActivityBinding) getMBinding()).ivLeft.setScaleX(1.0f);
            ((GligarControlOperationActivityBinding) getMBinding()).ivLeft.setScaleY(1.0f);
            ((GligarControlOperationActivityBinding) getMBinding()).ivRight.setAlpha(0.5f);
            ControlViewModel controlViewModel3 = this.viewModel;
            if (controlViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        ...
        ((GligarControlOperationActivityBinding) getMBinding()).ivRight.setScaleX(1.0f);
        ((GligarControlOperationActivityBinding) getMBinding()).ivRight.setScaleY(1.0f);
        ((GligarControlOperationActivityBinding) getMBinding()).ivLeft.setAlpha(0.5f);
