package com.nothing.elekid.control.os;
...
import com.nothing.elekid.control.ControlViewModel;
...
public final class ElekidControlOperationActivity extends ControlOperationActivity {
    ...
    public static final class Companion {
        ...
        public final void start(Bundle bundle, final OsControlActivity context, ControlConfigurationEntity.Operation options, Boolean isLeft) {
            ...
            Intent intent = new Intent(context, (Class<?>) ElekidControlOperationActivity.class);
            intent.putExtras(bundle);
            context.getResultLauncher().launcher(intent, new Function1() { // from class: com.nothing.elekid.control.os.ElekidControlOperationActivity$Companion$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return ElekidControlOperationActivity.Companion.start$lambda$0(context, (ActivityResult) obj);
                }
            });
        }
    ...
    public ControlGestureViewModel createGestureViewModel(ControlConfigurationEntity.Operation operation) {
        ...
        return new ControlItemViewModel(operation, this, getViewModel().getAddress(), false, 8, null);
    }
    ...
    public boolean onClickTransparency(ControlOperationViewModel dialogItemViewModel, ControlGestureViewModel itemViewModel) {
        ...
        if (getViewModel() instanceof ControlViewModel) {
            ...
            Intrinsics.checkNotNull(viewModel, "null cannot be cast to non-null type com.nothing.elekid.control.ControlViewModel");
    ...
    public void refreshGestureData(BaseControlViewModel viewModel, boolean isLeft) {
        ...
        for (CommonBindingMoreType commonBindingMoreType : isLeft ? viewModel.getLeftGestureData() : viewModel.getRightGestureData()) {
            if (commonBindingMoreType instanceof ControlGestureViewModel) {
                ...
                ControlOperationViewModel controlOperationViewModel = null;
                ...
                if (Intrinsics.areEqual(numValueOf, options != null ? Integer.valueOf(options.getGesture()) : null)) {
                    ControlConfigurationEntity.Operation selectOperation2 = getSelectOperation();
                    Integer numValueOf2 = selectOperation2 != null ? Integer.valueOf(selectOperation2.getButton()) : null;
                    ...
                    if (Intrinsics.areEqual(numValueOf2, options2 != null ? Integer.valueOf(options2.getButton()) : null)) {
                        for (ControlOperationViewModel controlOperationViewModel2 : controlGestureViewModel.getOperationList()) {
                            ControlOperationViewModel controlOperationViewModel3 = controlOperationViewModel2;
                            if (controlOperationViewModel3 != null && controlOperationViewModel3.getOperation() == 51) {
                                controlOperationViewModel = controlOperationViewModel2;
                                break;
                            }
                        }
                        ControlOperationViewModel controlOperationViewModel4 = controlOperationViewModel;
                        if (controlOperationViewModel4 != null) {
                            controlGestureViewModel.getOperationList().remove(controlOperationViewModel4);
                        }
