...
import com.nothing.ear.databinding.DonphanControlOperationActivityBinding;
...
@Metadata(d1 = {"\u0000p\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 32\b\u0012\u0004\u0012\u00020\u00020\u0001:\u00013B\u0007\u00a2\u0006\u0004\b\u0003\u0010\u0004J\b\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0011\u001a\u00020\u0012H\u0016J\u0010\u0010\u0013\u001a\u00020\u00102\u0006\u0010\u0014\u001a\u00020\u0015H\u0016J\u0012\u0010\u0016\u001a\u00020\u00102\b\u0010\u0017\u001a\u0004\u0018\u00010\u0018H\u0016J\b\u0010\u0019\u001a\u00020\bH\u0002J\b\u0010\u001a\u001a\u00020\bH\u0002J\b\u0010\u001d\u001a\u00020\bH\u0002J\u000e\u0010\u001e\u001a\u00020\u00102\u0006\u0010\u0005\u001a\u00020\u0006J\u000e\u0010\u001f\u001a\u00020\u00102\u0006\u0010\u0005\u001a\u00020\u0006J\u0018\u0010 \u001a\u00020\u00102\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u001a\u001a\u00020\bH\u0002J\u0010\u0010!\u001a\u00020\u00102\u0006\u0010\"\u001a\u00020#H\u0002J\u0016\u0010$\u001a\u00020\u00102\u0006\u0010%\u001a\u00020&2\u0006\u0010\"\u001a\u00020'J(\u0010(\u001a\u00020\u00102\u0006\u0010)\u001a\u00020*2\u0006\u0010+\u001a\u00020*2\u0006\u0010,\u001a\u00020-2\u0006\u0010.\u001a\u00020-H\u0002J\b\u0010/\u001a\u00020\u0010H\u0002J\u0016\u00100\u001a\u00020\u00102\u0006\u0010%\u001a\u00020&2\u0006\u0010\"\u001a\u00020'J\u0016\u00101\u001a\u00020\u00102\u0006\u0010%\u001a\u00020&2\u0006\u0010\"\u001a\u00020'J\u0016\u00102\u001a\u00020\u00102\u0006\u0010%\u001a\u00020&2\u0006\u0010\"\u001a\u00020'R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082.\u00a2\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u00020\bX\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\t\"\u0004\b\n\u0010\u000bR\u0010\u0010\f\u001a\u0004\u0018\u00010\rX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\bX\u0082\u000e\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u001b\u001a\u00020\u001cX\u0082\u000e\u00a2\u0006\u0002\n\u0000\u00a8\u00064"}, d2 = {"Lcom/nothing/donphan/control/ControlOperationActivity;", "Lcom/nothing/earbase/control/BaseControlOperationActivity;", "Lcom/nothing/ear/databinding/DonphanControlOperationActivityBinding;", "<init>", "()V", "viewModel", "Lcom/nothing/donphan/control/ControlViewModel;", "isSelectLeft", "", "()Z", "setSelectLeft", "(Z)V", "selectedOperation", "Lcom/nothing/earbase/control/entity/ControlConfigurationEntity$Operation;", "changeOperation", "onBackPressedInner", "", "getVoiceAssistantCount", "", "createContentConfig", "contentConfig", "Lcom/nothing/base/view/BaseConfig;", "onInit", "savedInstanceState", "Landroid/os/Bundle;", "isRight", "isLeft", "clickTime", "", "checkValid", "onClickLeft", "onClickRight", "refreshGestureData", "onClickChangeData", "itemViewModel", "Lcom/nothing/earbase/control/ControlGestureViewModel;", "onSelectedOperation", "dialogItemViewModel", "Lcom/nothing/earbase/control/ControlOperationViewModel;", "Lcom/nothing/donphan/control/ControlItemViewModel;", "scaleSelectedView", "normalView", "Landroid/widget/ImageView;", "selectedView", "normalText", "Landroid/widget/TextView;", "selectedText", "setDefaultScaleSelected", "onClickTransparency", "onClickNoiseCancellation", "onClickOff", "Companion", "nt_ear_GoogleStoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class ControlOperationActivity extends BaseControlOperationActivity<DonphanControlOperationActivityBinding> {
    ...
    public void onBackPressedInner() {
        ((DonphanControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((DonphanControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.donphan_control_operation_activity);
        int i = BR.viewModel;
        ControlViewModel controlViewModel3 = this.viewModel;
        if (controlViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        ((DonphanControlOperationActivityBinding) getMBinding()).rvOperation.setLayoutManager(new LinearLayoutManager(this));
        ((DonphanControlOperationActivityBinding) getMBinding()).setEventHandler(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isRight() {
        return ((DonphanControlOperationActivityBinding) getMBinding()).ivRight.getScaleX() == 1.0f;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isLeft() {
        return ((DonphanControlOperationActivityBinding) getMBinding()).ivLeft.getScaleX() == 1.0f;
    }
    ...
    public final void onClickLeft(ControlViewModel viewModel) {
        ...
        if (checkValid()) {
            ...
            if (!isLeft()) {
                AppCompatImageView ivLeft = ((DonphanControlOperationActivityBinding) getMBinding()).ivLeft;
                Intrinsics.checkNotNullExpressionValue(ivLeft, "ivLeft");
                AppCompatImageView ivRight = ((DonphanControlOperationActivityBinding) getMBinding()).ivRight;
                Intrinsics.checkNotNullExpressionValue(ivRight, "ivRight");
                AppCompatTextView tvLeft = ((DonphanControlOperationActivityBinding) getMBinding()).tvLeft;
                Intrinsics.checkNotNullExpressionValue(tvLeft, "tvLeft");
                AppCompatTextView tvRight = ((DonphanControlOperationActivityBinding) getMBinding()).tvRight;
    ...
    private final void onClickChangeData(final ControlGestureViewModel itemViewModel) {
        ...
        ((DonphanControlOperationActivityBinding) getMBinding()).rvOperation.setAdapter(new CommonBindingAdapter.Builder().setLayoutId(R.layout.donphan_control_dialog_item).setEventHandler((Object) this).addVariable(BR.itemViewModel, (Object) itemViewModel).setDataList((ObservableArrayList) itemViewModel.getOperationList()).build());
        ControlViewModel controlViewModel = this.viewModel;
        if (controlViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            controlViewModel = null;
        ...
        ((DonphanControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(8);
        ((DonphanControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((DonphanControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(8);
        ((DonphanControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
        if (Intrinsics.areEqual((Object) itemViewModel.isLeft().get(), (Object) true)) {
            ((DonphanControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(0);
            ((DonphanControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.donphan.control.ControlOperationActivity$$ExternalSyntheticLambda1
            ...
            ((DonphanControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(0);
            ((DonphanControlOperationActivityBinding) getMBinding()).rightLottie.postDelayed(new Runnable() { // from class: com.nothing.donphan.control.ControlOperationActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final void onClickChangeData$lambda$2(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setRepeatCount(-1);
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.playAnimation();
    }
    ...
    public static final void onClickChangeData$lambda$3(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setRepeatCount(-1);
        ((DonphanControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.playAnimation();
    }
    ...
    private final void setDefaultScaleSelected() {
        ...
        controlViewModel.getDataUpdate().observe(this, new ControlOperationActivityKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.donphan.control.ControlOperationActivity$$ExternalSyntheticLambda0
        ...
        if (this.isSelectLeft) {
            ((DonphanControlOperationActivityBinding) getMBinding()).ivLeft.setScaleX(1.0f);
            ((DonphanControlOperationActivityBinding) getMBinding()).ivLeft.setScaleY(1.0f);
            ((DonphanControlOperationActivityBinding) getMBinding()).ivRight.setAlpha(0.5f);
            ControlViewModel controlViewModel3 = this.viewModel;
            if (controlViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        ...
        ((DonphanControlOperationActivityBinding) getMBinding()).ivRight.setScaleX(1.0f);
        ((DonphanControlOperationActivityBinding) getMBinding()).ivRight.setScaleY(1.0f);
        ((DonphanControlOperationActivityBinding) getMBinding()).ivLeft.setAlpha(0.5f);
