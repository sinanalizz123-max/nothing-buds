...
import com.nothing.ear.databinding.EarColorControlOperationActivityBinding;
...
public final class ControlOperationActivity extends BaseControlOperationActivity<EarColorControlOperationActivityBinding> {
    ...
    public void onBackPressedInner() {
        ((EarColorControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((EarColorControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.ear_color_control_operation_activity);
        int i = BR.viewModel;
        ControlViewModel controlViewModel3 = this.viewModel;
        if (controlViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        ((EarColorControlOperationActivityBinding) getMBinding()).rvOperation.setLayoutManager(new LinearLayoutManager(this));
        ((EarColorControlOperationActivityBinding) getMBinding()).setEventHandler(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isRight() {
        return ((EarColorControlOperationActivityBinding) getMBinding()).ivRight.getScaleX() == 1.0f;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isLeft() {
        return ((EarColorControlOperationActivityBinding) getMBinding()).ivLeft.getScaleX() == 1.0f;
    }
    ...
    public final void onClickLeft(ControlViewModel viewModel) {
        ...
        if (checkValid()) {
            ...
            if (!isLeft()) {
                AppCompatImageView ivLeft = ((EarColorControlOperationActivityBinding) getMBinding()).ivLeft;
                Intrinsics.checkNotNullExpressionValue(ivLeft, "ivLeft");
                AppCompatImageView ivRight = ((EarColorControlOperationActivityBinding) getMBinding()).ivRight;
                Intrinsics.checkNotNullExpressionValue(ivRight, "ivRight");
                AppCompatTextView tvLeft = ((EarColorControlOperationActivityBinding) getMBinding()).tvLeft;
                Intrinsics.checkNotNullExpressionValue(tvLeft, "tvLeft");
                AppCompatTextView tvRight = ((EarColorControlOperationActivityBinding) getMBinding()).tvRight;
    ...
    private final void onClickChangeData(final ControlGestureViewModel itemViewModel) {
        ...
        ((EarColorControlOperationActivityBinding) getMBinding()).rvOperation.setAdapter(new CommonBindingAdapter.Builder().setLayoutId(R.layout.ear_color_control_dialog_item).setEventHandler((Object) this).addVariable(BR.itemViewModel, (Object) itemViewModel).setDataList((ObservableArrayList) itemViewModel.getOperationList()).build());
        ControlViewModel controlViewModel = this.viewModel;
        if (controlViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            controlViewModel = null;
        ...
        ((EarColorControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(8);
        ((EarColorControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((EarColorControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(8);
        ((EarColorControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
        if (Intrinsics.areEqual((Object) itemViewModel.isLeft().get(), (Object) true)) {
            ((EarColorControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(0);
            ((EarColorControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.ear.color.control.ControlOperationActivity$$ExternalSyntheticLambda1
            ...
            ((EarColorControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(0);
            ((EarColorControlOperationActivityBinding) getMBinding()).rightLottie.postDelayed(new Runnable() { // from class: com.nothing.ear.color.control.ControlOperationActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final void onClickChangeData$lambda$2(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setRepeatCount(-1);
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.playAnimation();
    }
    ...
    public static final void onClickChangeData$lambda$3(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setRepeatCount(-1);
        ((EarColorControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.playAnimation();
    }
    ...
    private final void setDefaultScaleSelected() {
        ...
        controlViewModel.getDataUpdate().observe(this, new ControlOperationActivityKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.ear.color.control.ControlOperationActivity$$ExternalSyntheticLambda0
        ...
        if (this.isSelectLeft) {
            ((EarColorControlOperationActivityBinding) getMBinding()).ivLeft.setScaleX(1.0f);
            ((EarColorControlOperationActivityBinding) getMBinding()).ivLeft.setScaleY(1.0f);
            ((EarColorControlOperationActivityBinding) getMBinding()).ivRight.setAlpha(0.5f);
            ControlViewModel controlViewModel3 = this.viewModel;
            if (controlViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        ...
        ((EarColorControlOperationActivityBinding) getMBinding()).ivRight.setScaleX(1.0f);
        ((EarColorControlOperationActivityBinding) getMBinding()).ivRight.setScaleY(1.0f);
        ((EarColorControlOperationActivityBinding) getMBinding()).ivLeft.setAlpha(0.5f);
