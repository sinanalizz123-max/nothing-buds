...
import io.mimi.hte.BuildConfig;
...
@DebugMetadata(c = "com.nothing.ear.color.control.ControlViewModel$setAncGestureData$1$1", f = "ControlViewModel.kt", i = {}, l = {220, 221, BuildConfig.VERSION_CODE}, m = "invokeSuspend", n = {}, s = {})
final class ControlViewModel$setAncGestureData$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x007f, code lost:
        ...
        if (r12.this$0.updateGestureData(r12.$viewModel, r12.$it, r12.$dialogItemViewModel, r12.$operation, r12) == r0) goto L20;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 2;
        if (BuildersKt.withContext(Dispatchers.getMain(), new AnonymousClass1(this.this$0, zBooleanValue, this.$it, this.$operation, this.$dialogItemViewModel, null), this) != coroutine_suspended) {
            this.label = 3;
        }
        return coroutine_suspended;
    }

    /* JADX INFO: renamed from: com.nothing.ear.color.control.ControlViewModel$setAncGestureData$1$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: ControlViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.ear.color.control.ControlViewModel$setAncGestureData$1$1$1", f = "ControlViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(ControlViewModel controlViewModel, boolean z, ControlConfigurationEntity.Operation operation, int i, ControlOperationViewModel controlOperationViewModel, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = controlViewModel;
            this.$result = z;
            this.$it = operation;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(this.this$0, this.$result, this.$it, this.$operation, this.$dialogItemViewModel, continuation);
        }
