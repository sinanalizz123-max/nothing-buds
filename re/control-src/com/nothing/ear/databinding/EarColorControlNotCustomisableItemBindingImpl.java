...
public class EarColorControlNotCustomisableItemBindingImpl extends EarColorControlNotCustomisableItemBinding {
    ...
    public EarColorControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private EarColorControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarColorControlNotCustomisableItemBinding
