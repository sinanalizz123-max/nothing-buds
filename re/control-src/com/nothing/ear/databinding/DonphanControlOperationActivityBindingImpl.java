...
public class DonphanControlOperationActivityBindingImpl extends DonphanControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public DonphanControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private DonphanControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.DonphanControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback100);
            BindingAdapter.onClick(this.ivRight, this.mCallback101);
            BindingAdapter.onClick(this.tvLeft, this.mCallback102);
            BindingAdapter.onClick(this.tvRight, this.mCallback103);
        }
        if ((j & 784) != j2) {
