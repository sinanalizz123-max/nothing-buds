...
import com.nothing.gligar.control.ControlActivity;
import com.nothing.gligar.control.ControlItemViewModel;

/* JADX INFO: loaded from: /tmp/source/classes6.dex */
public class GligarControlItemBindingImpl extends GligarControlItemBinding implements OnClickListener.Listener {
    ...
    public GligarControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private GligarControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GligarControlItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback212, zIsCanClick);
        }
