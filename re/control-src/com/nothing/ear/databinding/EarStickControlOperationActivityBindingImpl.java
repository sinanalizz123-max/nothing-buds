...
public class EarStickControlOperationActivityBindingImpl extends EarStickControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public EarStickControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private EarStickControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarStickControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback286);
            BindingAdapter.onClick(this.ivRight, this.mCallback287);
            BindingAdapter.onClick(this.tvLeft, this.mCallback288);
            BindingAdapter.onClick(this.tvRight, this.mCallback289);
        }
        if ((j & 784) != j2) {
