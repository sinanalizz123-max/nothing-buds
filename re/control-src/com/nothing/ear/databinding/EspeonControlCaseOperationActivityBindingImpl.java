...
public class EspeonControlCaseOperationActivityBindingImpl extends EspeonControlCaseOperationActivityBinding {
    ...
    public EspeonControlCaseOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private EspeonControlCaseOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EspeonControlCaseOperationActivityBinding
