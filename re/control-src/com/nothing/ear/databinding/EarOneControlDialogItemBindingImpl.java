...
public class EarOneControlDialogItemBindingImpl extends EarOneControlDialogItemBinding implements OnClickListener.Listener {
    ...
    public EarOneControlDialogItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private EarOneControlDialogItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarOneControlDialogItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 4096) != 0) {
            BindingAdapter.onClick(this.mboundView10, this.mCallback29);
            BindingAdapter.textLineHeight(this.mboundView4, 22);
            BindingAdapter.onClick((ViewGroup) this.mboundView7, this.mCallback28);
        }
        if ((j & 6176) != 0) {
        ...
        if ((j & j5) != 0) {
            ViewBindingAdapter.setOnClick(this.mboundView3, this.mCallback27, z);
