...
public class EarTwosControlNotCustomisableItemBindingImpl extends EarTwosControlNotCustomisableItemBinding {
    ...
    public EarTwosControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private EarTwosControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarTwosControlNotCustomisableItemBinding
