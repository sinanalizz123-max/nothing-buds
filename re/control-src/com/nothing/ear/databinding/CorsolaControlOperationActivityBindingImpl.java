...
import com.nothing.corsola.control.ControlViewModel;
...
public class CorsolaControlOperationActivityBindingImpl extends CorsolaControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public CorsolaControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private CorsolaControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.CorsolaControlOperationActivityBinding
    ...
    /* JADX WARN: Code duplicated, block: B:67:0x00ed A[DONT_INVERT] */
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback326);
            BindingAdapter.onClick(this.ivRight, this.mCallback327);
            BindingAdapter.onClick(this.tvLeft, this.mCallback328);
            BindingAdapter.onClick(this.tvRight, this.mCallback329);
        }
        if ((j & 784) != j2) {
            BindingAdapter.setRes(this.ivLeft, num3);
        }
        if ((j & 832) != j2) {
            BindingAdapter.setRes(this.ivRight, num);
        }
        if ((j & j3) != j2) {
            BindingAdapter.setRes(this.ivTitle, num2);
        }
        if ((j & 770) != j2) {
