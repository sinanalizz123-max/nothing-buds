...
public class GirafarigControlCaseOperationActivityBindingImpl extends GirafarigControlCaseOperationActivityBinding {
    ...
    public GirafarigControlCaseOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private GirafarigControlCaseOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GirafarigControlCaseOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((111 & j) != 0) {
            ...
            if ((j & 104) != 0) {
                ObservableField<Integer> caseSelectedRes = controlViewModel != null ? controlViewModel.getCaseSelectedRes() : null;
                updateRegistration(3, caseSelectedRes);
                if (caseSelectedRes != null) {
                    num2 = caseSelectedRes.get();
                }
            }
        } else {
            num = null;
        ...
        if ((104 & j) != 0) {
            BindingAdapter.setRes(this.ivLeft, num2);
        }
        if ((102 & j) != 0) {
