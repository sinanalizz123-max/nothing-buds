...
public class EarOneControlItemBindingImpl extends EarOneControlItemBinding implements OnClickListener.Listener {
    ...
    public EarOneControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private EarOneControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarOneControlItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback285, zIsCanClick);
        }
