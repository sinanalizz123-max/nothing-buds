...
public class GirafarigControlCaseDialogItemBindingImpl extends GirafarigControlCaseDialogItemBinding implements OnClickListener.Listener {
    ...
    public GirafarigControlCaseDialogItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private GirafarigControlCaseDialogItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GirafarigControlCaseDialogItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j5 & 524288) != 0) {
            BindingAdapter.onClick(this.mboundView10, this.mCallback251);
            BindingAdapter.onClick((ViewGroup) this.mboundView12, this.mCallback252);
            BindingAdapter.onClick(this.mboundView15, this.mCallback253);
            BindingAdapter.onClick(this.mboundView8, this.mCallback249);
            BindingAdapter.onClick(this.mboundView9, this.mCallback250);
        }
        if ((j5 & 787456) != 0) {
        ...
        if ((j5 & 819200) != 0) {
            ViewBindingAdapter.setOnClick(this.mboundView3, this.mCallback248, zSafeUnbox);
        }
        if ((j5 & 786464) != 0) {
