...
public class ContrlNotCustomisableItemBindingImpl extends ContrlNotCustomisableItemBinding {
    ...
    public ContrlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ContrlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.ContrlNotCustomisableItemBinding
