...
public class FlaffyControlItemBindingImpl extends FlaffyControlItemBinding implements OnClickListener.Listener {
    ...
    public FlaffyControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private FlaffyControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.FlaffyControlItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback200, zIsCanClick);
        }
