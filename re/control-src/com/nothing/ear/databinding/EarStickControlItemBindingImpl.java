...
public class EarStickControlItemBindingImpl extends EarStickControlItemBinding implements OnClickListener.Listener {
    ...
    public EarStickControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private EarStickControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarStickControlItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback283, zIsCanClick);
        }
