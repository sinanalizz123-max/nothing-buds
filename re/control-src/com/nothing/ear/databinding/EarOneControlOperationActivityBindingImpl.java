...
public class EarOneControlOperationActivityBindingImpl extends EarOneControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public EarOneControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private EarOneControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 7, (View) bindings[12], (ConstraintLayout) bindings[7], (AppCompatImageView) bindings[1], (AppCompatImageView) bindings[2], (AppCompatImageView) bindings[5], (LottieAnimationView) bindings[8], (LinearLayoutCompat) bindings[13], (LottieAnimationView) bindings[11], (RecyclerView) bindings[14], (Space) bindings[9], (Space) bindings[10], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[6]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.nothing.ear.databinding.EarOneControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback242);
            BindingAdapter.onClick(this.ivRight, this.mCallback243);
            BindingAdapter.onClick(this.tvLeft, this.mCallback245);
            BindingAdapter.onClick(this.tvRight, this.mCallback244);
        }
        if ((j & 784) != j2) {
    ...
    public final void _internalCallbackOnClick(int sourceId, View callbackArg_0) {
        ...
        if (sourceId == 3) {
            ...
            if (controlOperationActivity3 != null) {
                controlOperationActivity3.onClickRight(controlViewModel3);
                return;
            }
            return;
        }
        ...
        if (controlOperationActivity4 != null) {
            controlOperationActivity4.onClickLeft(controlViewModel4);
        }
    }
}
