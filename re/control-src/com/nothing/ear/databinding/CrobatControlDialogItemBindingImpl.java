...
public class CrobatControlDialogItemBindingImpl extends CrobatControlDialogItemBinding implements OnClickListener.Listener {
    ...
    public CrobatControlDialogItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private CrobatControlDialogItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.CrobatControlDialogItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j6 & 65536) != 0) {
            BindingAdapter.onClick((ViewGroup) this.mboundView11, this.mCallback239);
            BindingAdapter.onClick(this.mboundView14, this.mCallback240);
            BindingAdapter.textLineHeight(this.mboundView4, 22);
            BindingAdapter.onClick(this.mboundView7, this.mCallback236);
            BindingAdapter.onClick(this.mboundView8, this.mCallback237);
            BindingAdapter.onClick(this.mboundView9, this.mCallback238);
        }
        if ((j6 & 98368) != 0) {
        ...
        if ((j6 & j3) != 0) {
            ViewBindingAdapter.setOnClick(this.mboundView3, this.mCallback235, z);
