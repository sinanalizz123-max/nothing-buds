...
public class EspeonControlOperationActivityBindingImpl extends EspeonControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public EspeonControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private EspeonControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EspeonControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback149);
            BindingAdapter.onClick(this.ivRight, this.mCallback150);
            BindingAdapter.onClick(this.tvLeft, this.mCallback151);
            BindingAdapter.onClick(this.tvRight, this.mCallback152);
        }
        if ((j & 784) != j2) {
