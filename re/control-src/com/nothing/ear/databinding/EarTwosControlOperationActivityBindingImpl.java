...
public class EarTwosControlOperationActivityBindingImpl extends EarTwosControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public EarTwosControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private EarTwosControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarTwosControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback96);
            BindingAdapter.onClick(this.ivRight, this.mCallback97);
            BindingAdapter.onClick(this.tvLeft, this.mCallback98);
            BindingAdapter.onClick(this.tvRight, this.mCallback99);
        }
        if ((j & 784) != j2) {
