...
public class GligarControlOperationActivityBindingImpl extends GligarControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public GligarControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private GligarControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GligarControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback163);
            BindingAdapter.onClick(this.ivRight, this.mCallback164);
            BindingAdapter.onClick(this.tvLeft, this.mCallback165);
            BindingAdapter.onClick(this.tvRight, this.mCallback166);
        }
        if ((j & 784) != j2) {
