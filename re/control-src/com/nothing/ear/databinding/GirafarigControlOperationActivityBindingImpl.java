...
public class GirafarigControlOperationActivityBindingImpl extends GirafarigControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public GirafarigControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private GirafarigControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GirafarigControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback184);
            BindingAdapter.onClick(this.ivRight, this.mCallback185);
            BindingAdapter.onClick(this.tvLeft, this.mCallback186);
            BindingAdapter.onClick(this.tvRight, this.mCallback187);
        }
        if ((j & 784) != j2) {
