...
import com.nothing.ear.color.control.ControlActivity;
import com.nothing.ear.color.control.ControlItemViewModel;
...
public class EarColorControlItemBindingImpl extends EarColorControlItemBinding implements OnClickListener.Listener {
    ...
    public EarColorControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private EarColorControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewModel((ControlItemViewModel) variable);
        return true;
    }

    @Override // com.nothing.ear.databinding.EarColorControlItemBinding
    ...
    @Override // com.nothing.ear.databinding.EarColorControlItemBinding
    public void setViewModel(ControlItemViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        ControlItemViewModel controlItemViewModel = this.mViewModel;
        long j4 = 392;
        float f2 = 0.0f;
        if ((447 & j) != 0) {
            if ((j & 385) == 0) {
                ...
                ObservableField<Integer> gestureIndexRes = controlItemViewModel != null ? controlItemViewModel.getGestureIndexRes() : null;
            ...
            if ((j & 386) == 0) {
                ...
                ObservableField<String> operationName = controlItemViewModel != null ? controlItemViewModel.getOperationName() : null;
            ...
            if ((j & 388) != 0) {
                ObservableField<Integer> arrowVisible = controlItemViewModel != null ? controlItemViewModel.getArrowVisible() : null;
                j3 = 400;
            ...
            if ((j & 384) == 0 || controlItemViewModel == null) {
                zIsCanClick = false;
                direction = null;
            } else {
                zIsCanClick = controlItemViewModel.isCanClick();
                direction = controlItemViewModel.getDirection();
            }
            if ((j & 392) != 0) {
                ObservableField<String> gestureName = controlItemViewModel != null ? controlItemViewModel.getGestureName() : null;
                updateRegistration(3, gestureName);
                str2 = gestureName != null ? gestureName.get() : null;
                if ((j & j3) == 0) {
                    str3 = null;
                } else {
                    if (controlItemViewModel != null) {
                        itemDesc = controlItemViewModel.getItemDesc();
                    } else {
                        itemDesc = null;
                    }
                ...
                if ((j & 416) != 0) {
                    if (controlItemViewModel != null) {
                        alphaItem = controlItemViewModel.getAlphaItem();
                    } else {
                        alphaItem = null;
                    }
                    j2 = 416;
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback13, zIsCanClick);
        }
    ...
    public final void _internalCallbackOnClick(int sourceId, View callbackArg_0) {
        ...
        if (controlActivity != null) {
            controlActivity.onClickItem(controlItemViewModel);
        }
    }
}
