...
public class FlaffyControlNotCustomisableItemBindingImpl extends FlaffyControlNotCustomisableItemBinding {
    ...
    public FlaffyControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FlaffyControlNotCustomisableItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.FlaffyControlNotCustomisableItemBinding
