...
public class EarTwoControlOperationActivityBindingImpl extends EarTwoControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public EarTwoControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private EarTwoControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EarTwoControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback176);
            BindingAdapter.onClick(this.ivRight, this.mCallback177);
            BindingAdapter.onClick(this.tvLeft, this.mCallback178);
            BindingAdapter.onClick(this.tvRight, this.mCallback179);
        }
        if ((j & 784) != j2) {
