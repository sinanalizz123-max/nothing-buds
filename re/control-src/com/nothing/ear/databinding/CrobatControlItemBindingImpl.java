...
public class CrobatControlItemBindingImpl extends CrobatControlItemBinding implements OnClickListener.Listener {
    ...
    public CrobatControlItemBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private CrobatControlItemBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.CrobatControlItemBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 384) != 0) {
            ...
            ViewBindingAdapter.setOnClick(this.mboundView1, this.mCallback80, zIsCanClick);
        }
