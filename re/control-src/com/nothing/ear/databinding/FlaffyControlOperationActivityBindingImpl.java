...
public class FlaffyControlOperationActivityBindingImpl extends FlaffyControlOperationActivityBinding implements OnClickListener.Listener {
    ...
    public FlaffyControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private FlaffyControlOperationActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.FlaffyControlOperationActivityBinding
    ...
    protected void executeBindings() {
        ...
        if ((512 & j) != j2) {
            BindingAdapter.onClick(this.ivLeft, this.mCallback272);
            BindingAdapter.onClick(this.ivRight, this.mCallback273);
            BindingAdapter.onClick(this.tvLeft, this.mCallback274);
            BindingAdapter.onClick(this.tvRight, this.mCallback275);
        }
        if ((j & 784) != j2) {
