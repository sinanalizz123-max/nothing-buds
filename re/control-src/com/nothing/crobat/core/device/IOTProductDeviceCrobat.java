...
import com.nothing.crobat.base.CrobatImpl;
import com.nothing.crobat.core.CrobatDevice;
import com.nothing.crobat.core.protocol.device.CrobatOTAProcess;
import com.nothing.crobat.core.protocol.device.CrobatProtocol;
import com.nothing.crobat.widget.IOTCrobatWidgetAction;
...
/* JADX INFO: compiled from: IOTProductDeviceCrobat.kt */
/* JADX INFO: loaded from: /tmp/source/classes6.dex */
@Metadata(d1 = {"\u0000|\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u0000 +2\u00020\u0001:\u0001+B\u0007\u00a2\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H\u0002J\b\u0010\u0006\u001a\u00020\u0007H\u0016J\b\u0010\b\u001a\u00020\u0007H\u0016J\b\u0010\t\u001a\u00020\nH\u0016J\u001c\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\r\u0012\u0004\u0012\u00020\r0\f2\u0006\u0010\u000e\u001a\u00020\nH\u0016J\b\u0010\u000f\u001a\u00020\nH\u0016J\u001a\u0010\u0010\u001a\u0004\u0018\u00010\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0013H\u0016J\b\u0010\u0015\u001a\u00020\u0016H\u0016J6\u0010\u0017\u001a\u00020\u00112\f\u0010\u0018\u001a\b\u0012\u0004\u0012\u00020\u001a0\u00192\u0006\u0010\u001b\u001a\u00020\u001c2\u0006\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u0014\u001a\u00020\u00132\u0006\u0010\u001f\u001a\u00020\u0013H\u0016JD\u0010 \u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\"0!j\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\"`#2\u0006\u0010$\u001a\u00020%2\u0006\u0010&\u001a\u00020'2\u0006\u0010(\u001a\u00020)2\u0006\u0010*\u001a\u00020\u0007H\u0016\u00a8\u0006,"}, d2 = {"Lcom/nothing/crobat/core/device/IOTProductDeviceCrobat;", "Lcom/nothing/device/IOTProductDevice;", "<init>", "()V", "initDeviceGesture", "", "hasBassBoostFunction", "", "hasSpatialAudioFunction", "getTwsDeviceType", "", "getSimpleCustomEQParameter", "Lkotlin/Pair;", "", "type", "getSupportANCLevel", "createOSOTADevice", "Lcom/nothing/base/router/BaseNothingDevice;", "address", "", "modelId", "createOTAProcess", "Lcom/nothing/ota/entity/OTAProcess;", "createOsDevice", "callbacks", "Landroid/os/RemoteCallbackList;", "Landroid/os/IInterface;", "handler", "Landroid/os/Handler;", "coroutineScope", "Lkotlinx/coroutines/CoroutineScope;", "macAddress", "createFunctionComponents", "Ljava/util/HashMap;", "Lcom/nothing/device/BaseFunctionComponents;", "Lkotlin/collections/HashMap;", "context", "Landroid/content/Context;", "iotDevice", "Lcom/nothing/device/IOTDevice;", "lifecycleOwner", "Landroidx/lifecycle/LifecycleOwner;", "twsConnected", "Companion", "nt_ear_GoogleStoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class IOTProductDeviceCrobat extends IOTProductDevice {
    public static final String EAR_ID = "AE35FD";
    public static final String EAR_ORANGE_ID = "4DFC4A";
    public static final String EAR_WHITE_ID = "26C190";
    public static final String PRODUCT_ID = "B164";
    ...
    public IOTProductDeviceCrobat() {
        setDeviceName("Neckband Pro");
        setProductId("B164");
        setProjectId("22271");
        setProductReleaseOrder("1");
        setDeviceType(DeviceType.TWS);
        setAction(new IOTCrobatAction());
        setOsAction(new IOTCrobatOsAction());
        setGestureAction(new IOTEarCrobatGestureAction());
        getDeviceList().add(new IOTCrobatBlack());
        getDeviceList().add(new IOTCrobatWhite());
        getDeviceList().add(new IOTCrobatOrange());
        setWidgetAction(new IOTCrobatWidgetAction());
        setIntroduceMsg(R.string.neckband_pair_guide);
        setIntroduceSummary(R.string.pair_guide_question_ear1);
        setCaseLottieJson("lottie/crobat_pairing.json");
        setProtocol(new CrobatProtocol());
        setSupportImage(R.drawable.crobat_origin);
        setCaseImage(0);
        setBluetoothName("CMF Neckband Pro");
        setHelpDeviceName("Neckband Pro");
        setPushTopic("ear_crobat_firmware");
        setStereo(true);
    ...
    public BaseNothingDevice createOSOTADevice(String address, String modelId) {
        ...
        return new CrobatDevice(address, modelId);
    }

    @Override // com.nothing.device.IOTProductDevice
    public OTAProcess createOTAProcess() {
        return new CrobatOTAProcess();
    }
    ...
    public BaseNothingDevice createOsDevice(RemoteCallbackList<IInterface> callbacks, Handler handler, CoroutineScope coroutineScope, String modelId, String macAddress) {
        ...
        return new CrobatImpl(callbacks, handler, coroutineScope, modelId, macAddress);
    }
