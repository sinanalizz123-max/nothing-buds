...
public final class ControlItemViewModel extends ControlGestureViewModel {
    ...
    /* JADX INFO: compiled from: ControlItemViewModel.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0015\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003R\u0011\u0010\u0004\u001a\u00020\u0005\u00a2\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u0005\u00a2\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007R\u0011\u0010\n\u001a\u00020\u0005\u00a2\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\u0007\u00a8\u0006\f"}, d2 = {"Lcom/nothing/crobat/control/ControlItemViewModel$Companion;", "", "<init>", "()V", "SUPPORT_DOUBLE_OPERATIONS", "", "getSUPPORT_DOUBLE_OPERATIONS", "()[I", "SUPPORT_OPERATIONS", "getSUPPORT_OPERATIONS", "SUPPORT_OPERATIONS_MORE", "getSUPPORT_OPERATIONS_MORE", "nt_ear_GoogleStoreRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
        ...
        if (gesture == 1) {
            ...
            while (i < length) {
                ...
                if (i2 == 0) {
                    ...
                    z = z2;
                    if (i2 == SUPPORT_DOUBLE_OPERATIONS.length - 1) {
                        controlOperationViewModel.setDirection(ControlRadius.END);
                    }
                }
                controlOperationViewModel.selectedOperation(it.getOperation() == i3 ? z : false);
            ...
            while (i9 < length3) {
                ...
                controlOperationViewModel4.getItemSelectRadioVisible().set(false);
                if (i10 == 0) {
                ...
                if (i11 == 10) {
                    controlOperationViewModel4.selectedOperation(controlOperationViewModel4.convertAnc(it.getOperation(), true));
