package com.nothing.girafarig.control.os;
...
import com.nothing.girafarig.control.ControlViewModel;
...
public final class GirafarigControlOperationActivity extends ControlOperationActivity {
    ...
    public static final class Companion {
        ...
        public final void start(Bundle bundle, final OsControlActivity context, ControlConfigurationEntity.Operation options, Boolean isLeft) {
            ...
            Intent intent = new Intent(context, (Class<?>) GirafarigControlOperationActivity.class);
            intent.putExtras(bundle);
            context.getResultLauncher().launcher(intent, new Function1() { // from class: com.nothing.girafarig.control.os.GirafarigControlOperationActivity$Companion$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return GirafarigControlOperationActivity.Companion.start$lambda$0(context, (ActivityResult) obj);
                }
            });
        }
    ...
    public boolean onClickTransparency(ControlOperationViewModel dialogItemViewModel, ControlGestureViewModel itemViewModel) {
        ...
        if (getViewModel() instanceof ControlViewModel) {
            ...
            Intrinsics.checkNotNull(viewModel, "null cannot be cast to non-null type com.nothing.girafarig.control.ControlViewModel");
