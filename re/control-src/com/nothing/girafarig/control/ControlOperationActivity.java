...
import com.nothing.ear.databinding.GirafarigControlOperationActivityBinding;
...
public final class ControlOperationActivity extends BaseControlOperationActivity<GirafarigControlOperationActivityBinding> {
    ...
    public void onBackPressedInner() {
        ((GirafarigControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((GirafarigControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.girafarig_control_operation_activity);
        int i = BR.viewModel;
        ControlViewModel controlViewModel3 = this.viewModel;
        if (controlViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        ((GirafarigControlOperationActivityBinding) getMBinding()).rvOperation.setLayoutManager(new LinearLayoutManager(this));
        ((GirafarigControlOperationActivityBinding) getMBinding()).setEventHandler(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isRight() {
        return ((GirafarigControlOperationActivityBinding) getMBinding()).ivRight.getScaleX() == 1.0f;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isLeft() {
        return ((GirafarigControlOperationActivityBinding) getMBinding()).ivLeft.getScaleX() == 1.0f;
    }
    ...
    public final void onClickLeft(ControlViewModel viewModel) {
        ...
        if (checkValid()) {
            ...
            if (!isLeft()) {
                AppCompatImageView ivLeft = ((GirafarigControlOperationActivityBinding) getMBinding()).ivLeft;
                Intrinsics.checkNotNullExpressionValue(ivLeft, "ivLeft");
                AppCompatImageView ivRight = ((GirafarigControlOperationActivityBinding) getMBinding()).ivRight;
                Intrinsics.checkNotNullExpressionValue(ivRight, "ivRight");
                AppCompatTextView tvLeft = ((GirafarigControlOperationActivityBinding) getMBinding()).tvLeft;
                Intrinsics.checkNotNullExpressionValue(tvLeft, "tvLeft");
                AppCompatTextView tvRight = ((GirafarigControlOperationActivityBinding) getMBinding()).tvRight;
    ...
    private final void onClickChangeData(final ControlGestureViewModel itemViewModel) {
        ...
        ((GirafarigControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(8);
        ((GirafarigControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((GirafarigControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(8);
        ((GirafarigControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
        if (Intrinsics.areEqual((Object) itemViewModel.isLeft().get(), (Object) true)) {
            ((GirafarigControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(0);
            ((GirafarigControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.girafarig.control.ControlOperationActivity$$ExternalSyntheticLambda0
            ...
            ((GirafarigControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(0);
            ((GirafarigControlOperationActivityBinding) getMBinding()).rightLottie.postDelayed(new Runnable() { // from class: com.nothing.girafarig.control.ControlOperationActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final void onClickChangeData$lambda$2(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setRepeatCount(-1);
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.playAnimation();
    }
    ...
    public static final void onClickChangeData$lambda$3(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setRepeatCount(-1);
        ((GirafarigControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.playAnimation();
    }
    ...
    private final void setDefaultScaleSelected() {
        ...
        controlViewModel.getDataUpdate().observe(this, new ControlOperationActivityKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.girafarig.control.ControlOperationActivity$$ExternalSyntheticLambda2
        ...
        if (this.isSelectLeft) {
            ((GirafarigControlOperationActivityBinding) getMBinding()).ivLeft.setScaleX(1.0f);
            ((GirafarigControlOperationActivityBinding) getMBinding()).ivLeft.setScaleY(1.0f);
            ((GirafarigControlOperationActivityBinding) getMBinding()).ivRight.setAlpha(0.5f);
            ControlViewModel controlViewModel3 = this.viewModel;
            if (controlViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        ...
        ((GirafarigControlOperationActivityBinding) getMBinding()).ivRight.setScaleX(1.0f);
        ((GirafarigControlOperationActivityBinding) getMBinding()).ivRight.setScaleY(1.0f);
        ((GirafarigControlOperationActivityBinding) getMBinding()).ivLeft.setAlpha(0.5f);
