package com.nothing.heracross.device;
...
import com.nothing.espeon.core.device.IOTEspeonAction;
import com.nothing.espeon.core.device.IOTEspeonOsAction;
...
public final class IOTProductDeviceHeracross extends IOTProductDevice {
    ...
    public IOTProductDeviceHeracross() {
        setDeviceName("24253");
        ...
        getDeviceList().add(new IOTHeracrossBlack());
        getDeviceList().add(new IOTHeracrossWhite());
        getDeviceList().add(new IOTHeracrossOrange());
        getDeviceList().add(new IOTHeracrossBlue());
        setWidgetAction(new TWSWidgetAction());
        setCaseLottieJson("lottie/espeon_case_help_pairing.json");
        setProtocol(new EspeonProtocol());
        setBluetoothName("24253");
        setHasFeedback(true);
        setHelpDeviceName("24253");
        setPushTopic("ear_heracross_firmware");
