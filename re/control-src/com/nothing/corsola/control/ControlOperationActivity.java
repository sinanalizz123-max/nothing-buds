...
import com.nothing.ear.databinding.CorsolaControlOperationActivityBinding;
...
public final class ControlOperationActivity extends BaseControlOperationActivity<CorsolaControlOperationActivityBinding> {
    ...
    public void onBackPressedInner() {
        ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((CorsolaControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.corsola_control_operation_activity);
        int i = BR.viewModel;
        ControlViewModel controlViewModel3 = this.viewModel;
        if (controlViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        ((CorsolaControlOperationActivityBinding) getMBinding()).rvOperation.setLayoutManager(new LinearLayoutManager(this));
        ((CorsolaControlOperationActivityBinding) getMBinding()).setEventHandler(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isRight() {
        return ((CorsolaControlOperationActivityBinding) getMBinding()).ivRight.getScaleX() == 1.0f;
    }

    /* JADX WARN: Multi-variable type inference failed */
    private final boolean isLeft() {
        return ((CorsolaControlOperationActivityBinding) getMBinding()).ivLeft.getScaleX() == 1.0f;
    }
    ...
    public final void onClickLeft(ControlViewModel viewModel) {
        ...
        if (checkValid()) {
            ...
            if (!isLeft()) {
                AppCompatImageView ivLeft = ((CorsolaControlOperationActivityBinding) getMBinding()).ivLeft;
                Intrinsics.checkNotNullExpressionValue(ivLeft, "ivLeft");
                AppCompatImageView ivRight = ((CorsolaControlOperationActivityBinding) getMBinding()).ivRight;
                Intrinsics.checkNotNullExpressionValue(ivRight, "ivRight");
                AppCompatTextView tvLeft = ((CorsolaControlOperationActivityBinding) getMBinding()).tvLeft;
                Intrinsics.checkNotNullExpressionValue(tvLeft, "tvLeft");
                AppCompatTextView tvRight = ((CorsolaControlOperationActivityBinding) getMBinding()).tvRight;
    ...
    private final void onClickChangeData(final ControlGestureViewModel itemViewModel) {
        ...
        ((CorsolaControlOperationActivityBinding) getMBinding()).rvOperation.setAdapter(new CommonBindingAdapter.Builder().setLayoutId(R.layout.corsola_control_dialog_item).setEventHandler((Object) this).addVariable(BR.itemViewModel, (Object) itemViewModel).setDataList((ObservableArrayList) itemViewModel.getOperationList()).build());
        ControlViewModel controlViewModel = this.viewModel;
        if (controlViewModel == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
            controlViewModel = null;
        ...
        ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(8);
        ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.cancelAnimation();
        ((CorsolaControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(8);
        ((CorsolaControlOperationActivityBinding) getMBinding()).rightLottie.cancelAnimation();
        if (Intrinsics.areEqual((Object) itemViewModel.isLeft().get(), (Object) true)) {
            ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.setVisibility(0);
            ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.corsola.control.ControlOperationActivity$$ExternalSyntheticLambda1
            ...
            ((CorsolaControlOperationActivityBinding) getMBinding()).rightLottie.setVisibility(0);
            ((CorsolaControlOperationActivityBinding) getMBinding()).leftLottie.postDelayed(new Runnable() { // from class: com.nothing.corsola.control.ControlOperationActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static final void onClickChangeData$lambda$2(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.setRepeatCount(-1);
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).leftLottie.playAnimation();
    }
    ...
    public static final void onClickChangeData$lambda$3(ControlOperationActivity controlOperationActivity, ControlGestureViewModel controlGestureViewModel) {
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setAnimation(controlGestureViewModel.getLottieString().get());
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.setRepeatCount(-1);
        ((CorsolaControlOperationActivityBinding) controlOperationActivity.getMBinding()).rightLottie.playAnimation();
    }
    ...
    private final void setDefaultScaleSelected() {
        ...
        controlViewModel.getDataUpdate().observe(this, new ControlOperationActivityKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.corsola.control.ControlOperationActivity$$ExternalSyntheticLambda0
        ...
        if (this.isSelectLeft) {
            ((CorsolaControlOperationActivityBinding) getMBinding()).ivLeft.setScaleX(1.0f);
            ((CorsolaControlOperationActivityBinding) getMBinding()).ivLeft.setScaleY(1.0f);
            ((CorsolaControlOperationActivityBinding) getMBinding()).ivRight.setAlpha(0.5f);
            ControlViewModel controlViewModel3 = this.viewModel;
            if (controlViewModel3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        ...
        ((CorsolaControlOperationActivityBinding) getMBinding()).ivRight.setScaleX(1.0f);
        ((CorsolaControlOperationActivityBinding) getMBinding()).ivRight.setScaleY(1.0f);
        ((CorsolaControlOperationActivityBinding) getMBinding()).ivLeft.setAlpha(0.5f);
