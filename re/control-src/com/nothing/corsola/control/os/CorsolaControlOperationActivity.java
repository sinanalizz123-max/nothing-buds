package com.nothing.corsola.control.os;
...
public final class CorsolaControlOperationActivity extends ControlOperationActivity {
    ...
    public static final class Companion {
        ...
        public final void start(Bundle bundle, final OsControlActivity context, ControlConfigurationEntity.Operation options, Boolean isLeft) {
            ...
            Intent intent = new Intent(context, (Class<?>) CorsolaControlOperationActivity.class);
            intent.putExtras(bundle);
            context.getResultLauncher().launcher(intent, new Function1() { // from class: com.nothing.corsola.control.os.CorsolaControlOperationActivity$Companion$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return CorsolaControlOperationActivity.Companion.start$lambda$0(context, (ActivityResult) obj);
                }
            });
        }
    ...
    public boolean onClickTransparency(ControlOperationViewModel dialogItemViewModel, ControlGestureViewModel itemViewModel) {
        ...
        if (getViewModel() instanceof ControlViewModel) {
            ...
            Intrinsics.checkNotNull(viewModel, "null cannot be cast to non-null type com.nothing.corsola.control.ControlViewModel");
