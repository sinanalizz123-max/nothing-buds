...
import com.nothing.earbase.ota.BaseFirmwareViewModel;
...
@DebugMetadata(c = "com.nothing.corsola.control.ControlViewModel$setGestureData$1$1", f = "ControlViewModel.kt", i = {}, l = {97, BaseFirmwareViewModel.PROGRESS_MAX_98}, m = "invokeSuspend", n = {}, s = {})
final class ControlViewModel$setGestureData$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x006f, code lost:
        ...
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new com.nothing.corsola.control.ControlViewModel$setGestureData$1$1.AnonymousClass1(r11.this$0, r5, r11.$dialogItemViewModel, r11.$viewModel, null), r11) == r0) goto L15;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.this$0.syncData(this.$dialogItemViewModel, this.$it, this.$viewModel);
            this.label = 1;
    ...
    /* JADX INFO: renamed from: com.nothing.corsola.control.ControlViewModel$setGestureData$1$1$1, reason: invalid class name */
    /* JADX INFO: compiled from: ControlViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.nothing.corsola.control.ControlViewModel$setGestureData$1$1$1", f = "ControlViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(ControlViewModel controlViewModel, boolean z, ControlOperationViewModel controlOperationViewModel, ControlGestureViewModel controlGestureViewModel, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = controlViewModel;
            this.$result = z;
            this.$dialogItemViewModel = controlOperationViewModel;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(this.this$0, this.$result, this.$dialogItemViewModel, this.$viewModel, continuation);
        }
