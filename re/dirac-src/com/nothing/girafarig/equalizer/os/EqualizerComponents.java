...
public final class EqualizerComponents extends BaseFunctionComponents {
    ...
    public EqualizerComponents(final Context context, IOTDevice iotDevice, LifecycleOwner lifecycleOwner) {
        ...
        this.viewModel = LazyKt.lazy(new Function0() { // from class: com.nothing.girafarig.equalizer.os.EqualizerComponents$$ExternalSyntheticLambda0
    ...
    public void addListener(boolean clearObserver) {
        ...
        liveData.observe(getLifecycleOwner(), new EqualizerComponents$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.girafarig.equalizer.os.EqualizerComponents$$ExternalSyntheticLambda1
