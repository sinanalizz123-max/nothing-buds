...
import com.nothing.ear.databinding.GirafarigDiracEqGuideDialogBinding;
...
public final class DiracEQGuideDialog extends ForBottomPopupWindow<GirafarigDiracEqGuideDialogBinding> {
    ...
    public final void show(ComponentActivity activity, EqualizerViewModel viewModel, Function0<Unit> action, Function0<Unit> negativeAction) {
        ...
        super.show(activity);
        GirafarigDiracEqGuideDialogBinding binding = getBinding();
        if (binding != null) {
            binding.setViewModel(viewModel);
        }
        GirafarigDiracEqGuideDialogBinding binding2 = getBinding();
        if (binding2 != null) {
            binding2.setEventHandler(this);
        }
        GirafarigDiracEqGuideDialogBinding binding3 = getBinding();
        if (binding3 != null) {
