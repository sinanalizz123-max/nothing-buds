...
import com.nothing.ear.databinding.GirafarigEqualizerActivityBinding;
...
public final class EqualizerActivity extends BaseActivity<GirafarigEqualizerActivityBinding> implements OnEQChangeListener {
    ...
    public void createContentConfig(BaseConfig contentConfig) {
        ...
        BaseConfig layoutId = contentConfig.setLayoutId(R.layout.girafarig_equalizer_activity);
        int i = BR.viewModel;
    ...
    public void rightLabelClickEvent() {
        ...
        diracEQGuideDialog2.show(equalizerActivity, equalizerViewModel, new Function0() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Unit.INSTANCE;
            }
        }, new Function0() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Unit.INSTANCE;
            }
    ...
    public void onInit(Bundle savedInstanceState) {
        ...
        noScrollGridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity.onInit.1
        ...
        CommonBindingAdapter.Builder eventHandler = new CommonBindingAdapter.Builder().setLayoutId(R.layout.girafarig_equalizer_item).setEventHandler((Object) this);
        EqualizerViewModel equalizerViewModel3 = this.viewModel;
        if (equalizerViewModel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("viewModel");
        } else {
    ...
    @Override // com.nothing.base.view.BaseActivity
    public void onInitObserver(GirafarigEqualizerActivityBinding binding) {
        ...
        EqualizerActivity equalizerActivity = this;
        equalizerViewModel.getCustomEqState().observe(equalizerActivity, new EqualizerActivity$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda0
        ...
        equalizerViewModel2.getNeedHDACWarning().observe(equalizerActivity, new EqualizerActivity$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit onInitObserver$lambda$7(final EqualizerActivity equalizerActivity, WarnEqualizerTypeViewModel warnEqualizerTypeViewModel) {
        if (warnEqualizerTypeViewModel != null && warnEqualizerTypeViewModel.getWarning()) {
            ...
            confirmMsgDialog.show(equalizerActivity, equalizerActivity.hdacWarningViewModel, new Function0() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return EqualizerActivity.onInitObserver$lambda$7$lambda$5(this.f$0);
                }
            }, new Function0() { // from class: com.nothing.girafarig.equalizer.EqualizerActivity$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
