...
public class DonphanDiracEqGuideDialogBindingImpl extends DonphanDiracEqGuideDialogBinding implements OnClickListener.Listener {
    ...
    public DonphanDiracEqGuideDialogBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private DonphanDiracEqGuideDialogBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.DonphanDiracEqGuideDialogBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            BindingAdapter.onClick(this.secondText, this.mCallback309);
        }
    }
