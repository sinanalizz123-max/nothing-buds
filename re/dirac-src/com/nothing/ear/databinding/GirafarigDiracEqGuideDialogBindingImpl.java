...
public class GirafarigDiracEqGuideDialogBindingImpl extends GirafarigDiracEqGuideDialogBinding implements OnClickListener.Listener {
    ...
    public GirafarigDiracEqGuideDialogBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private GirafarigDiracEqGuideDialogBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.GirafarigDiracEqGuideDialogBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            BindingAdapter.onClick(this.secondText, this.mCallback156);
        }
    }
