...
public class EspeonEqualizerActivityBindingImpl extends EspeonEqualizerActivityBinding {
    ...
    public EspeonEqualizerActivityBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private EspeonEqualizerActivityBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.nothing.ear.databinding.EspeonEqualizerActivityBinding
