...
public final class EqualizerComponents extends BaseFunctionComponents {
    ...
    public EqualizerComponents(final Context context, IOTDevice iotDevice, LifecycleOwner lifecycleOwner) {
        ...
        this.viewModel = LazyKt.lazy(new Function0() { // from class: com.nothing.os.device.bluetooth.components.EqualizerComponents$$ExternalSyntheticLambda1
    ...
    public void addListener(boolean clearObserver) {
        ...
        TWSDevice twsDevice;
        TWSDeviceBuilder tWSDeviceBuilderEQMode$default2;
        LiveData<Message> liveData2;
        if (clearObserver && (twsDevice = getIotDevice().getTwsDevice()) != null && (tWSDeviceBuilderEQMode$default2 = TWSDeviceExtKt.eQMode$default(twsDevice, 0, 1, null)) != null && (liveData2 = tWSDeviceBuilderEQMode$default2.getLiveData()) != null) {
        ...
        if (twsDevice2 == null || (tWSDeviceBuilderEQMode$default = TWSDeviceExtKt.eQMode$default(twsDevice2, 0, 1, null)) == null || (liveData = tWSDeviceBuilderEQMode$default.getLiveData()) == null) {
            return;
        }
        liveData.observe(getLifecycleOwner(), new EqualizerComponents$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.nothing.os.device.bluetooth.components.EqualizerComponents$$ExternalSyntheticLambda0
    ...
    public final void updateEQ(int type) {
        String string;
        if (type == 0) {
            string = getContext().getString(R.string.sound_balanced);
        } else if (type == 1) {
            string = getContext().getString(R.string.sound_more_voice);
        } else if (type == 2) {
            string = getContext().getString(R.string.sound_more_treble);
        } else if (type == 3) {
            string = getContext().getString(R.string.sound_more_bass);
        } else if (type == 5) {
            string = getContext().getString(R.string.sound_eq_custom);
        } else if (type == 6) {
            string = getContext().getString(R.string.sound_new_voice);
        } else if (type == 7) {
            string = getContext().getString(R.string.sound_new_instrument);
        } else {
            string = "";
        }
