...
import com.nothing.ear.databinding.DonphanDiracEqGuideDialogBinding;
...
public final class DiracEQGuideDialog extends ForBottomPopupWindow<DonphanDiracEqGuideDialogBinding> {
    ...
    public final void show(ComponentActivity activity, EqualizerViewModel viewModel, Function0<Unit> action, Function0<Unit> negativeAction) {
        ...
        super.show(activity);
        DonphanDiracEqGuideDialogBinding binding = getBinding();
        if (binding != null) {
            binding.setViewModel(viewModel);
        }
        DonphanDiracEqGuideDialogBinding binding2 = getBinding();
        if (binding2 != null) {
            binding2.setEventHandler(this);
        }
        DonphanDiracEqGuideDialogBinding binding3 = getBinding();
        if (binding3 != null) {
