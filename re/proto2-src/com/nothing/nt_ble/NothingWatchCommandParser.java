...
public class NothingWatchCommandParser implements XByteArrayParser {
    ...
    public static /* synthetic */ String toHexString$default(NothingWatchCommandParser nothingWatchCommandParser, int i, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        return nothingWatchCommandParser.toHexString(i, i2);
    }
    ...
    public static /* synthetic */ int toInt$default(NothingWatchCommandParser nothingWatchCommandParser, byte[] bArr, int i, int i2, int i3, Object obj) {
        if (obj != null) {
        ...
        return nothingWatchCommandParser.toInt(bArr, i, i2);
    }
