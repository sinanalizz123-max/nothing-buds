...
public final class ActsSppRawParser implements XByteArrayParser {
    ...
    public XCommand getReceiveCommand(String uuid, int index, byte[] byteArray) {
        ...
        return new XCommand("raw", 0, 0, false, 0, 0, 0, (1 > index || index >= byteArray.length) ? byteArray : ArraysKt.copyOfRange(byteArray, index, byteArray.length), uuid, null, 638, null);
    }
